...
namespace phadec.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly phadecDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = phadecConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(phadecDbContext context)
        {
            _context = context;
        }
