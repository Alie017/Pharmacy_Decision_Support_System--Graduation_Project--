...
{
    public abstract class phadecWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static phadecWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(phadecWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<phadecDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<phadecDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<phadecDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<phadecDbContext, Task<T>> func)
        {
            T result;
